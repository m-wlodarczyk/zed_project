...
patients_results <- df %>%
  select(patient_id, survived, 'Lactate dehydrogenase', 'lymphocyte count', 'High sensitivity C-reactive protein') %>%
  group_by(patient_id, survived) %>%
  ...
  ungroup() %>%
  select(survived, LDH, hsCRP, lymphocytes)
